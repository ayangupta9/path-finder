/* eslint-disable */
var astarHelper = (function () {
  var _scriptDir = './wasmalgos/astarHelper.wasm'

  return function (astarHelper) {
    astarHelper = astarHelper || {}

    var Module = typeof astarHelper !== 'undefined' ? astarHelper : {}
    ...
    if (Module['locateFile']) {
      wasmBinaryFile = './wasmalgos/astarHelper.wasm'
      //  if (!isDataURI(wasmBinaryFile)) {
      //   wasmBinaryFile = locateFile(wasmBinaryFile);
      //  }
    } else {
      wasmBinaryFile = './wasmalgos/astarHelper.wasm'
      //  new URL("astarHelper.wasm", import.meta.url).toString();
    }
    ...
    var _solveastar = (Module['_solveastar'] = function () {
      return (_solveastar = Module['_solveastar'] = Module['asm']['y']).apply(
        null,
        arguments
      )
    })
