...
var bestfsHelper = (function () {
  var _scriptDir = './wasmalgos/bestfsHelper.wasm'

  return function (bestfsHelper) {
    bestfsHelper = bestfsHelper || {}

    var Module = typeof bestfsHelper !== 'undefined' ? bestfsHelper : {}
    ...
    if (Module['locateFile']) {
      wasmBinaryFile = 'bestfsHelper.wasm'
      // if (!isDataURI(wasmBinaryFile)) {
      //   wasmBinaryFile = locateFile(wasmBinaryFile)
      // }
    } else {
      wasmBinaryFile = './wasmalgos/bestfsHelper.wasm'
      // new URL('bestfsHelper.wasm', import.meta.url).toString()
    }
    ...
    var _returnVector = (Module['_returnVector'] = function () {
      return (_returnVector = Module['_returnVector'] =
        Module['asm']['x']).apply(null, arguments)
    })

    var _solveBestFS = (Module['_solveBestFS'] = function () {
      return (_solveBestFS = Module['_solveBestFS'] = Module['asm']['y']).apply(
        null,
        arguments
      )
    })
    ...
    var _malloc = (Module['_malloc'] = function () {
      return (_malloc = Module['_malloc'] = Module['asm']['C']).apply(
        null,
        arguments
      )
    })
    ...
    return bestfsHelper.ready
  }
})()
export default bestfsHelper
