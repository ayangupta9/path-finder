...
var bfsHelper = (function () {
  var _scriptDir = './wasmalgos/bfsHelper.wasm'

  return function (bfsHelper) {
    bfsHelper = bfsHelper || {}

    var Module = typeof bfsHelper !== 'undefined' ? bfsHelper : {}
    ...
    if (Module['locateFile']) {
      wasmBinaryFile = 'bfsHelper.wasm'
      //  if (!isDataURI(wasmBinaryFile)) {
      //   wasmBinaryFile = locateFile(wasmBinaryFile);
      //  }
    } else {
      wasmBinaryFile = './wasmalgos/bfsHelper.wasm'
      //  new URL("bfsHelper.wasm", import.meta.url).toString();
    }
    ...
    var _solveBFS = (Module['_solveBFS'] = function () {
      return (_solveBFS = Module['_solveBFS'] = Module['asm']['y']).apply(
        null,
        arguments
      )
    })
