/* eslint-disable */
var dfsHelper = (function () {
  var _scriptDir = './wasmalgos/dfsHelper.wasm'

  return function (dfsHelper) {
    dfsHelper = dfsHelper || {}

    var Module = typeof dfsHelper !== 'undefined' ? dfsHelper : {}
    ...
    if (Module['locateFile']) {
      wasmBinaryFile = 'dfsHelper.wasm'
      // if (!isDataURI(wasmBinaryFile)) {
      //   wasmBinaryFile = locateFile(wasmBinaryFile)
      // }
    } else {
      wasmBinaryFile = './wasmalgos/dfsHelper.wasm'
      // new URL('dfsHelper.wasm', import.meta.url).toString()
    }
    ...
    var _solveDFS = (Module['_solveDFS'] = function () {
      return (_solveDFS = Module['_solveDFS'] = Module['asm']['y']).apply(
        null,
        arguments
      )
    })
