...
var dijkstraHelper = (function() {
  var _scriptDir = './wasmalgos/dijkstraHelper.wasm';
  
  return (
function(dijkstraHelper) {
  dijkstraHelper = dijkstraHelper || {};

var Module = typeof dijkstraHelper !== "undefined" ? dijkstraHelper : {};
...
if (Module["locateFile"]) {
 wasmBinaryFile = "dijkstraHelper.wasm";
//  if (!isDataURI(wasmBinaryFile)) {
//   wasmBinaryFile = locateFile(wasmBinaryFile);
//  }
} else {
 wasmBinaryFile = './wasmalgos/dijkstraHelper.wasm'
//  new URL("dijkstraHelper.wasm", import.meta.url).toString();
}
...
var _returnVector = Module["_returnVector"] = function() {
 return (_returnVector = Module["_returnVector"] = Module["asm"]["x"]).apply(null, arguments);
};

var _solveDijkstra = Module["_solveDijkstra"] = function() {
 return (_solveDijkstra = Module["_solveDijkstra"] = Module["asm"]["y"]).apply(null, arguments);
};
